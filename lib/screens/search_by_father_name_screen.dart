...
class SearchByFatherNameScreen extends StatefulWidget {
  const SearchByFatherNameScreen({super.key});

  @override
  State<SearchByFatherNameScreen> createState() => _SearchByFatherNameScreenState();
}

class _SearchByFatherNameScreenState extends State<SearchByFatherNameScreen> {
  ...
  Future<void> _loadUsers() async {
    ...
    await userProvider.fetchApprovedUsers(
      // Fetch all users to filter locally by father name
      search: null,
    );
  }
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Enter father name to search...',
          ...
          Expanded(
            child: Consumer<UserProvider>(
              builder: (context, userProvider, _) {
                ...
                // Filter results to only show users matching father name
                final filteredUsers = _searchController.text.isEmpty
                    ? []
                    : userProvider.approvedUsers.where((user) {
                        final fatherName = (user['fatherName'] ?? '').toString().toLowerCase();
                        final searchQuery = _searchController.text.toLowerCase();
                        return fatherName.contains(searchQuery);
                      }).toList();
